...
class SiteConfiguration(models.Model):
    ...
    # Secção do Formulário de Busca (Hero)
    ...
    # Secção "Quem Somos"
    about_us_header_image = models.ImageField(
        upload_to='pages/', blank=True, null=True,
        verbose_name="Imagem de Cabeçalho (Quem Somos)",
        help_text="Imagem de abertura da página. Dimensão recomendada: 1920x500 pixels."
    )
