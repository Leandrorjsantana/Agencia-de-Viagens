...
class SiteConfiguration(models.Model):
    # ... (todos os campos existentes até agora)

    # --- NOVOS CAMPOS PARA A PÁGINA DE TELEVENDAS ---
    ...
    televendas_page_title = models.CharField(max_length=100, blank=True, default="Fale com nossa equipa de Televendas", verbose_name="Título da Página de Televendas")
