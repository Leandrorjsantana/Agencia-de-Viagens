...
class Offer(models.Model):
    ...
    offer_code = models.CharField(max_length=20, unique=True, blank=True, verbose_name="Código da Oferta")
    ...
    destination_city = models.CharField(max_length=100, blank=True, verbose_name="Cidade de Destino")
    ...
    hotel_rating = models.DecimalField(max_digits=2, decimal_places=1, blank=True, null=True, verbose_name="Avaliação do Hotel (Ex: 8.5)")
    
    # --- CAMPOS IMPORTANTES PARA O AUTOPREENCHIMENTO ---
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, verbose_name="Preço Final")
    start_date = models.DateField(null=True, blank=True, verbose_name="Data de Início da Oferta")
    end_date = models.DateField(null=True, blank=True, verbose_name="Data de Fim da Oferta")
    ...
    promo_tag = models.CharField(max_length=50, blank=True, verbose_name="Tag Promocional")
