...
class Offer(models.Model):
    ...
    image = models.ImageField(upload_to='offers/', blank=True, null=True, verbose_name="Imagem do Card", help_text="Dimensão recomendada: 400x300 pixels")
    ...
    hotel_rating = models.DecimalField(max_digits=2, decimal_places=1, blank=True, null=True, verbose_name="Avaliação do Hotel (Ex: 8.5)", help_text="Use um número de 0.0 a 10.0")
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, verbose_name="Preço Final")
    original_price = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True, verbose_name="Preço Original (para mostrar economia)")
