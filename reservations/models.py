...
class Reservation(models.Model):
    ...
    # --- AJUSTE: A OFERTA AGORA É OBRIGATÓRIA ---
    offer = models.ForeignKey(Offer, on_delete=models.PROTECT, related_name='reservations', verbose_name="Oferta Associada")
    
    reservation_code = models.CharField(max_length=50, unique=True, blank=True, verbose_name="Código da Reserva")
...
class ReservationDocument(models.Model):
    ...
    description = models.CharField(max_length=100, verbose_name="Descrição do Documento")
